...
"SELECT projects.title, SUM(projects.funding_goal) - SUM(pledges.amount) FROM pledges INNER JOIN projects on projects.id = pledges.project_id GROUP BY projects.title;"
end
