...
"SELECT projects.category, SUM(pledges.amount) FROM pledges INNER JOIN users ON users.id = pledges.user_id GROUP BY projects.category WHERE projects.category = "
end
